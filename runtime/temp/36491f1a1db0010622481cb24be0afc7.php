<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"C:\wamp64\www\09juchang\public/../application/weichat\view\buy\shop_cart.html";i:1515501180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<script type="text/javascript">
		$('.footer_buy_mob2 div:eq(2)').click(function(){
			location.href="<?php echo url('weichat/buy/transaction'); ?>";
		});
		$('.show_del').click(function(){
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo url('weichat/buy/shop_cart_del'); ?>',
				dataType: 'json',
		...
		$('.show_min').click(function(){
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo url('weichat/buy/shop_cart_min'); ?>',
				dataType: 'json',
				data: {show_id:show_id},
				success: function(data){
		...
		$('.show_max').click(function(){
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo url('weichat/buy/shop_cart_max'); ?>',
				dataType: 'json',
		...
		$('.click_detail').click(function(){
			var show_id=$(this).siblings('.show_id').val();
			var shower_name=$(this).siblings('.shower_name').val();
			location.href="<?php echo url('weichat/buy/buytail'); ?>/show_id/"+show_id+"/shower_name/"+shower_name;
		});

		$('.footer_buy_mob2 div:eq(1)').click(function(){
			location.href="<?php echo url('weichat/buy/buy'); ?>";
		});
	</script>
</html>