<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"C:\wamp64\www\09juchang\public/../application/weichat\view\index\transaction.html";i:1515593619;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<script type="text/javascript">
		$('.show_right').click(function(){
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo url('weichat/index/transaction_del'); ?>',
				dataType: 'json',
