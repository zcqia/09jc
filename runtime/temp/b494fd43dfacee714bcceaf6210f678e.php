<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"C:\wamp64\www\09juchang\public/../application/weichat\view\index\buytail.html";i:1516160776;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	...
	<div class="main_mob">
		<div class="show_mob2">
			...
			<div class="show_content2">
				...
				<div id="zhuyan"><span id="zhuyan1">主演:<?php if(strlen($shower_name) > 42){
								  $str=$shower_name;
