<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\wamp64\www\09juchang\public/../application/weichat\view\buy\buytail.html";i:1515566906;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="main_mob">
		<div class="show_mob2">
			...
			<div class="show_content2">
				...
				<div>主演:<?php echo $shower_name; ?></div>
				<div>场次:<?php 
					...
					?></div>
				<div id="jianjie"><span id="desc">简介:<?php if(strlen($data[0]['show_describe']) > 96){
								  $str=$data[0]['show_describe'];
								  $str=mb_substr($str,0,31,'utf-8'); 
	...
	<script type="text/javascript">
		$('.footer_buy_mob div').click(function(){
			...
			location.href="<?php echo url('weichat/buy/shop_cart'); ?>/show_id/"+show_id+"/shower_name/"+shower_name;
		});
